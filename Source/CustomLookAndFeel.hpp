...
public:
  ...
  void drawRotarySlider(Graphics &g, int x, int y, int width, int height,
    ...
    for (int i = 1; i < numLines; i++) {
      ...
      line.addRectangle(-lineThickness * 0.5f, -radius - lineLength - 6.0f,
    ...
    if (suffix.equalsIgnoreCase(DIMENSION_FRACTION)) {
      short min = static_cast<int>(slider.getMinimum());
      short max = static_cast<int>(slider.getMaximum());
    ...
    g.drawFittedText(labelStart, 0, height - 26, width, 12, Justification::left,
                     1);
    g.drawFittedText(labelEnd, 0, height - 26, width, 12, Justification::right,
                     1);

    g.setFont(12.0f);
    g.drawFittedText(slider.getName(), 0, height - 12, width, 12,
  ...
  void drawLinearSlider(Graphics &g, int x, int y, int width, int height,
    ...
    Point<float> startPoint(slider.isHorizontal() ? x : x + width * 0.5f,
                            slider.isHorizontal() ? y + height * 0.5f
                                                  : height + y);
    ...
    g.setFont(12.0f);
    g.setColour(COLOUR_WHITE);
    g.drawFittedText(slider.getName(), 12, 0, width, 12, Justification::left,
                     1);
  }
};
